...
const PROJECTS = [
  ...
  },
  {
    ...
    preview: { type:'embed', height:620, items:[
      { url:'https://gmpark-creator.github.io/project-dashboard/claude/previews/semiconductor-universe/', label:'Knowledge Atlas — 상단 대분류로 [산업](반도체·전력 3D) ⇄ [기초이론](과학 71단원: 초28+중23+고20, 도해 69종) 전환. 기초이론은 과학→학교급(초/중/고)→학년·과목→단원 읽기형 학습자료. 고등은 통합과학·물리학·지구과학 과목 칩 (2026-06-01 고등 추가)' }
    ]},
