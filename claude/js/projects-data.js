...
const PROJECTS = [
  ...
  },
  {
    ...
    preview: { type:'embed', height:660, items:[
      { url:'https://gmpark-creator.github.io/project-dashboard/claude/previews/tradelogix-hub/', label:'VIEW → 카테고리 선택: 「통관절차」(부산항 통관 + Incoterms 2020 + 수입신고필증)와 「선사업무」(판다 익스프레스 라인 + MAGE 프로젝트 supply DB + 선박증서 31종)를 한 화면에서 선택·전환 — 보세사 뷰어는 1~5과목 2019~2025 전연도 875문항 + 2023년 1과목 B형(A·B형 토글) + 중요 개념·7개년 빈출(1~5과목 완성) + 정답 해설·빠른회독(1~5과목, 875문항 전수검증 PASS) + 희소 유형·낯선·저빈출(1~5과목 × 8선 = 40선 완성)' }
    ]},
