...
const PROJECTS = [
  ...
  },
  {
    ...
    latest: '2026-05-24',
    progress: 99,
    link: 'https://gmpark-creator.github.io/project-dashboard/solar-project-claude/',
    preview: { type:'embed', height:520, items:[
      { url:'https://gmpark-creator.github.io/project-dashboard/solar-project-claude/', label:'태양계 시뮬레이터' }
    ]},
  ...
  },
  {
    ...
    latest: '2026-05-27',
    progress: 1,
    link: 'http://127.0.0.1:5173/?variant=nano&lang=ko',
    preview: { type:'images', items:[
      { src:'previews/korea-gov-sim-nano-1-far.png',      label:'시야 멀리 — 라임 한반도 + 짙은 sage 외부 음영 + 미소 cloud + 청록 바다 (Gemini Nano Banana 미학)' },
      { src:'previews/korea-gov-sim-nano-2-national.png', label:'National view — 한반도 hero + 17 시도 라벨 + 북한 distinct + MDL 군사분계선 + drop shadow' },
      { src:'previews/korea-gov-sim-nano-3-seoul.png',    label:'Seoul deep zoom — 25 자치구 라벨 + GROUND-LEVEL VIEW 버튼 (청와대 진입) + 짙은 sage 외부 음영' }
    ]},
