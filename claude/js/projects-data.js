...
const PROJECTS = [
  ...
  },
  {
    ...
    subtitle: '여러 분야의 지식을 묶어 시각화하는 상위 아카이브 — 대분류 2층(① 산업: 반도체·전력 3D / ② 기초이론: 학교 과학) · A Curated Atlas of Interactive Knowledge',
    icon: 'book',
    ...
    preview: { type:'embed', height:620, items:[
      { url:'https://gmpark-creator.github.io/project-dashboard/claude/previews/semiconductor-universe/', label:'Knowledge Atlas — 상단 대분류로 [산업](반도체·전력 3D) ⇄ [기초이론](과학 129단원: 초28+중23+고78, 도해 127종) 전환. 기초이론은 과학→학교급(초/중/고)→학년·과목→단원 읽기형 학습자료. 고등은 선택군 네비게이션(공통·일반선택·진로선택·융합선택)으로 11과목 칩 구분 (2026-06-01 진로선택+네비 통합)' }
    ]},
    ...
    milestones: [
      ...
      { isCore:true, date:'2026-06-01', title:'대분류 2층 구조 + 기초이론(초등 과학) 신설', desc:'아틀라스를 「산업 / 기초이론」 2개 대분류로 재편. 기초이론에 학교 과학을 신설하고 초등 3~6학년 전 단원 28개를 본문·핵심용어·흥미사실로 집필 + 단원별 SVG 도해 22종 제작(전부 로컬). 산업/기초이론 최상단 전환, 중·고등은 준비 중. semiconductor-universe push 7ee3fbf, typecheck+build PASS.' },
