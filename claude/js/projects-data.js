...
const PROJECTS = [
  ...
  },
  {
    ...
    summary: '하나의 큰 틀 아래 여러 분야의 지식을 모아 시각화하는 8번째 프로젝트.\n'
           ...
           + '전력 공급망(KEPCO·한수원·발전5사·KPX·KOGAS·두산에너빌리티 등 23개 기업/기관을 본사 좌표로 한반도 지도에 핀하고 연료·발전·송배전·기자재 관계를 호로 연결). 전력 영역엔 「핵에너지 패러다임」 비교 패널(핵분열↔핵융합·석탄/우라늄/핵융합 연료질량 로그 차트·목표 GW 인터랙티브 계산기)을 추가(2026-06-05).\n'
