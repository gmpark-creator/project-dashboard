...
const PROJECTS = [
  ...
  },
  {
    ...
    preview: { type:'embed', height:620, items:[
      { url:'https://gmpark-creator.github.io/project-dashboard/claude/previews/semiconductor-universe/', label:'Knowledge Atlas — 상단 대분류로 [산업](반도체·전력 3D) ⇄ [기초이론](과학 51단원: 초등28+중등23, 도해 45종) 전환. 기초이론은 과학→학교급(초/중/고)→학년→단원 읽기형 학습자료 (2026-06-01 중등 추가)' }
    ]},
