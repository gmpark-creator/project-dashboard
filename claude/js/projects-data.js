...
const PROJECTS = [
  ...
  },
  {
    ...
    latest: '2026-05-24',
    progress: 99,
    link: 'https://gmpark-creator.github.io/project-dashboard/solar-project-claude/?v=moonphase',
    preview: { type:'embed', height:520, items:[
      { url:'https://gmpark-creator.github.io/project-dashboard/solar-project-claude/?v=moonphase', label:'태양계 시뮬레이터' }
    ]},
