...
const PROJECTS = [
  ...
  },
  {
    ...
    subtitle: '무역과 물류 — Part 1. 통관 마스터(Customs Clearance Core) · 부산항 북항/신항 통관 + Incoterms 2020 + 수입신고필증 / 선사 업무(MAGE 프로젝트 supply DB + 선박 증서 31종 도해) / 보세사 기출문제 뷰어(1과목 2025·2024·2023·2022·2021·2020년 — 공식정답표 전수검증)',
    icon: 'trade-globe',
