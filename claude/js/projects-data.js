...
const PROJECTS = [
  ...
  },
  {
    ...
    preview: { type:'embed', height:600, items:[
      ...
      { url:'https://gmpark-creator.github.io/project-dashboard/claude/previews/us-kr-premarket/director-log/', label:'디렉터 코멘트 — 실전 트레이딩 로그. 디렉터(G.M.PARK)가 장중 직접 관찰한 1인칭 SOXL 매매 일지. Entry 01 = 2026-06-18→19 네 마녀의 날 야간 복기(취침 시점 +19.38%, $279.20). (2026-06-19 신설)' },
    ...
    issues: [
      ...
      { type:'완료', title:'디렉터 코멘트 카테고리 신설 — 실전 트레이딩 로그 (Claude, 2026-06-19)', desc:'박사 직접 지시로 Polaris 허브에 「디렉터 코멘트」 카테고리(director-log/) 신설 — 디렉터(G.M.PARK)가 장중 직접 관찰·판단한 1인칭 SOXL 매매 일지. 허브 index.html 상단에 섹션 0(피처드 카드) 추가. Entry 01 = 2026-06-18→19 미국 본장 네 마녀의 날(준틴스 06-19 휴장으로 만기 목요일 앞당김) 야간 복기: 07시 기상 +3~4% → 야간선물 완만 우상향 → 17시 장통합 상향 → 프리장 +12.5~13.5% → 22:30 본장 개장(급락 예측 빗나가고 몇 분 만에 +1.5~2.5%↑ 말아올려 15~16%) → 03시 20%p까지 와리가리 점진 상승 → 03~04시 횡보. 16~20%p = 0.5% 차익 10분 단위 사팔사팔 단타 구간 메모. 제미나이·GPT 사전 전략(개장 직후·마감 직전 매도물량 속출 → 22시경/새벽3시 매도 추천) 기록. 취침 시점(06-19 03:40) SOXL 422,222원·$279.20·+19.38%. 다크 슬레이트 테마(허브 톤 정합), 연구·교육용 가드레일.' }
    ],
    milestones: [
      ...
      { isCore:true, date:'2026-06-19', title:'디렉터 코멘트 카테고리 신설 — 실전 트레이딩 로그 (Claude)', desc:'박사 직접 지시. Polaris 허브에 디렉터 1인칭 SOXL 매매 일지(director-log/) 신설 + 허브 섹션 0 피처드 카드. Entry 01 = 2026-06-18→19 네 마녀의 날(준틴스 휴장으로 만기 목요일 앞당김) 야간 복기 — 시간대별 무빙 타임라인(+3~4%→프리 12.5~13.5%→개장 직후 급락 예측 반전 15~16%→03시 20%p→횡보), 16~20%p 사팔사팔 단타 구간, 제미나이·GPT 사전 매도 전략, 취침 시점(03:40) +19.38%·$279.20·422,222원. 연구·교육용 가드레일. progress 30 고정.' }
    ]
  },
  {
    id: 'knowledge',
