...
const PROJECTS = [
  ...
  },
  {
    ...
    issues: [
      ...
      { type:'완료', title:'반도체 영역 — 공급망 도시 줌 + 우클릭 화면이동 (2026-05-30)', desc:'공급망에서 회사 클릭 시 본사 도시 상공까지 더 깊게 확대 + 선택 회사를 정확한 본사 좌표에 작은 지도 핀으로 표시(라벨 화면 고정 크기로 근접 시 거대화 방지). 마우스 우클릭 드래그로 화면 이동(pan) 추가, 근접 줌 허용. Playwright 검증·재배포. push 9b20978.' },
    ...
    milestones: [
      ...
      { isCore:true, date:'2026-05-30', title:'영역 1 — 공급망 도시 줌 + 우클릭 pan', desc:'회사 선택 시 본사 도시까지 깊게 확대 + 정확한 본사 좌표에 작은 지도 핀, 우클릭 드래그 화면 이동(pan) 추가. push 9b20978.' }
    ]
  }
];
/* ▲▲▲  데이터 끝  ▲▲▲ */
