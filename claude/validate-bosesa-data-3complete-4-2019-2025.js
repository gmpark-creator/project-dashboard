...
const specs = [
  ...
  },
  {
    ...
    "expectedSubjectName": "자율관리 및 관세벌칙"
  }
];
...
for (const spec of specs) {
  ...
  if (spec.expectedSubjectName && data.subjectName !== spec.expectedSubjectName) { console.error(`[FAIL] ${prefix}: subjectName mismatch. expected=${spec.expectedSubjectName} got=${data.subjectName}`); ok = false; }
