...
- 태양계 Claude 버전 — 카이퍼 벨트(30~50 AU) · 오르트 구름(2,000~100,000 AU) 입자 시각화 추가, 선택 시 영역 윤곽선·라벨 표시
- 태양계 Claude 버전 — 외계 항성계 추가: 「프로젝트 헤일메리」의 40 Eridani(16.3 광년), 「삼체」의 알파 센타우리(4.37 광년) 실제 거리 반영
