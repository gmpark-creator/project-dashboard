export const reportData = {
  ...
  projects: [
    ...
    },
    {
      ...
      next: [
        ...
        '형님 피드백 기준으로 UI 문구, 모바일 배치, 행성 확대 카메라 거리를 한 번 더 조정.',
      ],
    },
    {
      id: 'inst',
  ...
  improvements: [
    {
      title: '태양계 공개 공유본 완성',
      body: 'Codex와 Claude 태양계 버전을 각각 공개 경로로 분리했고, 형님에게 바로 보낼 수 있는 URL 두 개를 확보했다.',
    },
    {
      title: '시간 이동 방식 개선',
  ...
  actions: [
    '태양계 Codex/Claude 공개 링크를 형님에게 공유하고 비주얼·조작감 피드백을 받는다.',
